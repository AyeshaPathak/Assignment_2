'''
File: fruit_tea.py
Description: This module contains the polymorphic class FruitTea and its methods for adding and removing toppings.
...
class FruitTea(BubbleTea):
  ...
  def add_topping(self, topping_name, drink_name): 
    ...
    if additional_choice == "Yes":
      ...
      print("Your total after toppings is: $", FruitTea.order_cost)
