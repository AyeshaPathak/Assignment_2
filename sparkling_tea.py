'''
File: sparkling_tea.py
Description: This module contains the polymorphic class SparklingTea and its methods for adding and removing toppings.
...
class SparklingTea(BubbleTea):
  ...
  def add_topping(self, topping_name, drink_name): 
    ...
    if additional_choice == "Yes":
      ...
      print("Your total after toppings is: $", SparklingTea.order_cost)
